...
# EDIT ME -- swap these rows for your own bio / stack / highlights.
ROWS = [
    ("host",),
    ("kv", "Building", "Forge -- autonomous dev framework for Claude Code"),
    ("kv", "Also", "devmon -- gamified terminal creature-collection RPG"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Core", "Python, Claude Code / Agent SDK"),
    ("kv", "Infra", "GitHub Actions, self-hosted servers"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Orn: autonomous kernel-orchestrated dev loop"),
    ("bul", "Runs 2 self-hosted modded Minecraft servers"),
]
